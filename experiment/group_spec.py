...
# Top level resources = [0, 1]
# Other resources     = [2, 3]
group_4_wide_2["resources"]        = 4
group_4_wide_2["type"]             = "wide"
group_4_wide_2["minimal_requests"] = [(0, 2), (0, 3), (1, 3)]
group_4_wide_2["nn_requests"]      = [(0,), (1,), (2,), (3,)]
group_4_wide_2["n_requests"]       = group_4_wide_2["minimal_requests"] + [(1, 2), (2, 3)]